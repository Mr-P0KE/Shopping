                ...
                <div>
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <c:forEach items="${list}" var="l">
                            <tr>
                                <td>${l.id}</td>
                                <td><a href="img/productSingle/${l.id}.jpg" title="点击查看原图"><img height="50px" src="img/productSingle/${l.id}.jpg"> </a> </td></td>
                                <td><a deleteLink="true" href="admin_productImage_delete?id=${l.id}"><span class="glyphicon glyphicon-trash"></span> </a> </td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
